...
const Navbar = () => {
  return (
        <nav className='border right-0 w-max left-auto top-0 bottom-auto border-zinc-800 sm:max-2xl:ml-10 mt-16 rounded-3xl text-white sm:max-2xl:px-5 bg-customDarkGray rounded-t-3xl rounded-b-none'>
            <ul className='flex flex-wrap items-center justify-center px-3 gap-5 sm:max-2xl:gap-8'>
                <Link to='/'>
